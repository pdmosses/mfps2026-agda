\subsection{PCF: A Programming Language for Computable
Functions}\label{Examples/PCF-pcf-a-programming-language-for-computable-functions}
...
\cite{Plotkin1977LCP}.
The Agda modules presented below are an embedding of the latter
definition.
